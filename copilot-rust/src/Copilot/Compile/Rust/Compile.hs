...
-- Internal imports
import Copilot.Compile.Rust.CodeGen  ( mkAccessDecln, mkBuffDecln, mkExtCpyDecln,
                                       mkExtDecln, mkGenFun, mkGenFunArray,
                                       mkIndexDecln, mkStep, mkStructDecln,
                                       mkStructForwDecln )
import Copilot.Compile.Rust.External ( External, gatherExts )
import Copilot.Compile.Rust.Name     ( argNames, generatorName,
                                       generatorOutputArgName, guardName )
import Copilot.Compile.Rust.Settings ( CSettings, cSettingsOutputDirectory,
